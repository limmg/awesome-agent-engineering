...
| 05 | [高级检索工程化：Ensemble + MultiQuery](05_advanced_retrieval/) | RAG L06、L07 |
...
| 08 | [状态持久化 + 人机协作](08_state_memory_hitl/) | Agent L05 |
| 09 | [毕业项目：LangGraph 研究助手](09_capstone/) | Agent L09、L07 |

> 目前已完成全部 **9 / 9** 节课 🎉。每课包含原理讲解 + 可运行代码 + 练习。
